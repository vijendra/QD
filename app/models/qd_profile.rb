class QdProfile < ActiveRecord::Base
  ...
  QDPROFILE_CSV_HEADERS = ['Order id','First Name','Mid Name','Last Name','Suffix','Address','City', 'State','Zip', 'Zip4','Ccrt', 'dpc', 'Phone','fico', 'PR01', 'HE_LENDERNAME', 'MTG_LENDERNAME', 'REV16', 'REV24', 'MKTVAL02_RANGE', 
				'MKTVAL02', 'FHAMTGBAL' ]
  QDPROFILE_CSV_FIELDS = ['listid','fname','mname','lname','suffix','address','city','state','zip','zip4','crrt','dpc','phone_num','pr01','fico', 'he_lendername', 'mtg_lendername', 'rev16', 'rev24', 'mktval02_range', 
				'mktval02', 'fhamtgbal']
  
  FIELDS_TO_BE_SHOWN = ['listid','fname','mname','lname','suffix','address','address2','city','state','zip','zip4','crrt','dpc','phone_num','pr01','fico', 'he_lendername', 'mtg_lendername', 'rev16', 'rev24', 'mktval02_range', 
				'mktval02', 'fhamtgbal']
  ...
  IMPORT_FILE_FIELDS = {'LISTID' => 'listid', 'LNAME' => 'lname', 'FNAME' => 'fname', 'MI' => 'mname',  
				...
				'HE_LENDERNAME' => 'he_lendername', 'MTG_LENDERNAME' => 'mtg_lendername', 'REV16' => 'rev16', 'REV24' => 'rev24', 'MKTVAL02_RANGE' => 'mktval02_range', 
				'MKTVAL02' => 'mktval02', 'FHAMTGBAL' => 'fhamtgbal' }
