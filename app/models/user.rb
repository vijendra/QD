...
class User < ActiveRecord::Base
  ...
  accepts_nested_attributes_for :profile, :address ,:site_image
  ...
  attr_accessible :dealer_id, :administrator_id,:login,:email, :name, :password, :password_confirmation, :identity_url, :address_attributes,:site_image_attributes, :profile_attributes, :administrator_profile_attributes
