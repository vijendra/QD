...
for data in @profiles
 ...
 p_pdf.bounding_box([box.right - 215, box.top - 80], :width => 200) do
  ...
  p_pdf.bounding_box([box.left + 110, box.top - 125], :width => 200) do
  ...
  p_pdf.text "Dear #{h(@name)}", :at => [box.left + 30, box.top - 245]

  p_pdf.text_box "#{h(@first_para)}",
    :width    =>  box.right - 70, :height => 100,
    :at       => [box.left + 30, box.top - 255]

  p_pdf.text_box "#{h(@name)}, #{h(@sec_para)}",
    :width    =>  box.right - 70, :height => 100,
    :at       => [box.left + 30, box.top - 315]

  p_pdf.bounding_box([box.left + 30, box.top - 380], :width => box.right - 60) do
  ...
  p_pdf.stroke_rectangle [60, box.bottom + 450], box.width - 250 , 70
  ...
  p_pdf.text @dealer_profile.display_name, :at => [132, box.top - 817]
